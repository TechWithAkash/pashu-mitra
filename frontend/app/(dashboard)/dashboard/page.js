...
import HealthMatrix from "@/components/dashboard/health-matrix";
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      {/* Row 1: Health Trend + Distribution Donut */}
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          animate="visible"
        >
          <PredictionDistribution predictions={predictions} />
        </motion.div>
      </div>

      {/* Row 2: Daily Activity + Health Matrix */}
      <div className="grid lg:grid-cols-3 gap-6">
        <motion.div
          custom={3}
          variants={sectionVariants}
          ...
          className="lg:col-span-2"
        >
          <DailyActivityChart predictions={predictions} />
        </motion.div>
        <motion.div
          custom={3.5}
          variants={sectionVariants}
          ...
          animate="visible"
        >
          <HealthMatrix predictions={predictions} />
        </motion.div>
      </div>

      {/* Row 3: Recent Results + Confidence Chart + Quick Scan */}
      <div className="grid lg:grid-cols-3 gap-6">
        <motion.div
          custom={4}
          variants={sectionVariants}
